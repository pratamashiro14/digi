		...
		<div class="container-menu-desktop">
				...
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
                        ...
                        <div class="account-dd p-lr-25">
                            <a href="#" class="account-toggle" onclick="return false;"><i class="zmdi zmdi-account"></i> <?php echo $nama_desainer; ?> (Desainer) <i class="zmdi zmdi-caret-down caret"></i></a>
                        ...
                        <div class="account-dd p-lr-25">
                            <a href="#" class="account-toggle" onclick="return false;"><i class="zmdi zmdi-account"></i> <?php echo $nama_user; ?> <i class="zmdi zmdi-caret-down caret"></i></a>
                            <div class="account-menu">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					<a href="#" class="logo"><img src="images/icons/logo-01.png?v=<?php echo time(); ?>" alt="IMG-LOGO"></a>
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu"><a href="index.php">Beranda</a></li>
		...
		<div class="menu-mobile">
			<ul class="topbar-mobile">
				...
				<li><div class="right-top-bar flex-w h-full">
                    ...
                    <?php if ($is_designer_logged_in) { ?>
                        <a href="profil_desainer.php" class="flex-c-m p-lr-10 trans-04"><i class="zmdi zmdi-account"></i>&nbsp;<?php echo $nama_desainer; ?></a>
                    ...
                    <?php } elseif ($is_user_logged_in) { ?>
                        <a href="profil.php" class="flex-c-m p-lr-10 trans-04"><i class="zmdi zmdi-account"></i>&nbsp;<?php echo $nama_user; ?></a>
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<div class="block1 wrap-pic-w">
						<img src="images/banner-01.png?v=<?php echo time(); ?>" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<div class="block1 wrap-pic-w">
						<img src="images/banner-02.png?v=<?php echo time(); ?>" alt="IMG-BANNER">
						<a href="product.php" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<div class="block1 wrap-pic-w">
						<img src="images/banner-03.png?v=<?php echo time(); ?>" alt="IMG-BANNER">
						<a href="product.php" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
