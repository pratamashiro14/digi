...
<html lang="en">
  ...
  <body>
    ...
    <div class="page-header">
        <h1 class="fw-bold mb-3">Data Premium</h1>
        </div>
...
<div class="col-md-12">
  <div class="card">
    <div class="card-header">
      <div class="card-title">Tabel Data Premium</div>
    </div>

    <div class="card-body">
      <a href="datapremium_tambah.php" class="btn btn-primary mb-3">+ Tambah Langganan</a>
      ...
      <table class="table table-hover">
        ...
        <tbody>
          ...
          $query = mysqli_query($koneksi, "
            ...
            ORDER BY p.id_premium DESC
          ");

          if (mysqli_num_rows($query) == 0) {
            echo "<tr><td colspan='7' class='text-center text-muted'>Belum ada data premium</td></tr>";
          } else {
          ...
          <tr>
            ...
            <td>
              <span class="badge bg-<?= $data['tipe_premium'] == 'buyer' ? 'info' : 'success'; ?>">
                <?= ucfirst($data['tipe_premium']); ?>
              </span>
            </td>
            <td><?= htmlspecialchars($data['tanggal_aktif']); ?></td>
            ...
            <td>
              <a href="datapremium_edit.php?id=<?= $data['id_premium']; ?>" class="text-primary me-2">
